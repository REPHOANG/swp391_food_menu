    ...
    <div class="page-body-wrapper">
        ...
        <div class="page-body">
            <div class="container-fluid">
                ...
                <form class="row g-4" action="ChangePasswordStaffController" method="post"
                    ...
                    <div class="col-12">
                        <div class="form-floating theme-form-floating">
                            <input type="text" class="form-control" id="currentPassword" name="currentPassword"
                                   placeholder="Current Password" required value="${user.password}">
...
<script>
    function validatePassword() {
        // Lấy giá trị của mật khẩu mới và xác nhận mật khẩu
        ...
        // Nếu mật khẩu khớp, ẩn thông báo lỗi và cho phép gửi form
