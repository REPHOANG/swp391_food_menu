                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <c:forEach var="order" items="${orders}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <ul>
                                                            <li>
                                                                <a href="<c:url value="OrderManagerController?orderAction=detailOrderAdmin&orderId=${order.orderId}"/>">
                                        ...
                                        <div>
                                            <c:if test="${currentPage > 1}">
                                                <a href="OrderManagerController?page=${currentPage - 1}&orderAction=${orderAction}&userId=${userId}">Previous</a>
                                            </c:if>
                                            ...
                                            <c:forEach begin="${startPage}" end="${endPage}" var="i">
                                                ...
                                                <c:if test="${i != currentPage}">
                                                    <a href="OrderManagerController?page=${i}&orderAction=${orderAction}&userId=${userId}">${i}</a> <!-- Các trang khác -->
                                                </c:if>
                                            </c:forEach>
                                            <c:if test="${currentPage < totalPages}">
                                                <a href="OrderManagerController?page=${currentPage + 1}&orderAction=${orderAction}&userId=${userId}">Next</a>
                                            </c:if>
                                        </div>
                                    </div>
                                </div>
