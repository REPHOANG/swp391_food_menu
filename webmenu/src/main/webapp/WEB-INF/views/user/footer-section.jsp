                    ...
                    <div class="col-xl-3 col-lg-4 col-sm-6">
                        <div class="footer-logo">
                            ...
                            <div class="footer-logo-contain">
                                <p>We are a modern fast-food spot where you can conveniently order delicious meals right from your table by scanning a QR code. Quick, easy, and perfect for a seamless dining experience!</p>

                                <ul class="address">
                                    <li>
                                        <i data-feather="home"></i>
                                        <a href="javascript:void(0)">Khu Công Nghệ Cao Hòa Lạc, km 29, Đại lộ, Thăng Long, Hà Nội, Việt Nam</a>
                                    </li>
                                    <li>
                                        <i data-feather="mail"></i>
                                        <a href="javascript:void(0)">4foodweb@gmail.com</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
