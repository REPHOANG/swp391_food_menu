                                ...
                                <li class="right-side onhover-dropdown">
                                    <div class="delivery-login-box">
                                        ...
                                        <div class="delivery-detail">
                                            <h6 id="user-greeting">Hello, ${sessionScope.user.username}</h6>
                                            <h5 id="user-name">${sessionScope.user.username}</h5>
                                        </div>
                                    </div>
    ...
    function loginByGoogle(response) {
        ...
        fetch("<c:url value="/MainController?btnAction=user&userAction=login&email="/>" + email + "&picture=" + avatar + "&username=" + username, {
            ...
            res.json()
                ...
                // Cập nhật giao diện với tên người dùng sau khi đăng nhập thành công
                document.getElementById("user-name").innerText = username; // Cập nhật tên người dùng
                document.getElementById("user-greeting").innerText = "Hello, " + username; // Cập nhật lời chào
                // Sau khi đăng nhập thành công, cập nhật giao diện:
                const userBox = document.querySelector('.user-box-name');
                // Xóa nút đăng nhập
                userBox.innerHTML = `
                     <li class="product-box-contain">
                         <a href="/MainController?btnAction=user&userAction=logout">Đăng xuất</a>
                     </li>
                 `;
            }
        )
