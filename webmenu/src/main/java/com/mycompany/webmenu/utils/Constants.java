...
public class Constants {
    ...
    public final static String LIST_CATEGORY_MANAGER_JSP = "WEB-INF/views/admin/category/list-category-manager.jsp";
    public final static String ADD_NEW_CATEGORY_JSP = "WEB-INF/views/admin/category/add-new-category.jsp";
    public final static String LIST_USER_MANAGER = "WEB-INF/views/admin/user/list-user-manager.jsp";
    public final static String LIST_ORDER_MANAGER = "WEB-INF/views/admin/order/list-order-manager.jsp";
