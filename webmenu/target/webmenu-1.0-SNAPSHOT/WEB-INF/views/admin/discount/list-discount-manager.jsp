                                        ...
                                        <ul>
                                            <li>
                                                <a class="btn btn-solid"
                                                   href="<c:url value="DiscountManagerController?discountAction=addDiscount"/>">Add
                                                    Discount</a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <div>
                                            <c:if test="${currentPage > 1}">
                                                <a href="DiscountManagerController?page=${currentPage - 1}">Previous</a>
                                            </c:if>
                                            ...
                                            <c:forEach begin="${startPage}" end="${endPage}" var="i">
                                                ...
                                                <c:if test="${i != currentPage}">
                                                    <a href="DiscountManagerController?page=${i}">${i}</a> <!-- Các trang khác -->
                                                </c:if>
                                            </c:forEach>
                                            <c:if test="${currentPage < totalPages}">
                                                <a href="DiscountManagerController?page=${currentPage + 1}">Next</a>
                                            </c:if>
                                        </div>
                                    </div>
                                </div>
