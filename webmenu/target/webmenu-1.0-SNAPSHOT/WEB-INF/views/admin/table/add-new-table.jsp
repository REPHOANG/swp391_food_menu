                        ...
                        <div class="col-sm-8 m-auto">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="theme-form theme-form-2 mega-form" action="./TableManagerController"
                                          method="post">
                                        <!-- Trường ẩn để truyền ID của table (tableId) -->
                                        <input class="form-control" type="hidden" name="tableId"
                                               value="${tableDTO.tableId}">

                                        <!-- Table Name -->
                                        <div class="mb-4 row align-items-center">
                                            <label class="form-label-title col-sm-3 mb-0">Table Name</label>
                                            <div class="col-sm-9">
                                                <input class="form-control" type="text" placeholder="Table Name"
                                                       name="tableName" value="${tableDTO.tableName}">
                                            </div>
                                        </div>
